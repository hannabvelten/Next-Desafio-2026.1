...
export default function Header(){
    return (
        <header className="bg-[#0F1C53] sticky top-0 z-20 w-full px-15 flex justify-center items-center">
            <div className="flex flex-1">
                ...
                <div className="flex flex-1 gap-14 w-full h-full text-[#FFFFFF] font-medium items-center">
