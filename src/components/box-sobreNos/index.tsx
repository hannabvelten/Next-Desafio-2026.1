...
export default function Box_SobreNos() {
    return (
        <div className="tudo w-full bg-brancoGelo flex px-4 lg:px-20 md:py-8">
            <div className="bg-amarelinho w-full md:h-110 lg:h-150 rounded-3xl flex h-70">
                <div className="texto p-6 md:w-130 w-130">
                    ...
                    <p className="text-xs lg:text-3xl md:text-xl md:px-11 md:tracking-wider">Do desenho ao acabamento final, nossas joias refletem sofisticação e cuidado. <br /> Peças versáteis, feitas para durar e brilhar em qualquer ocasião.</p>
                </div>
